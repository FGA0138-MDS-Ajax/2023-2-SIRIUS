...
// src/controllers/ParticipanteEmGrupo/ParticipanteEmGrupoController.spec.ts
describe("Testes unit\xE1rios para Controle de Dados na Tabela ParticipanteEmGrupoController", () => {
  let participanteEmGrupoController;
  let req;
  let res;
  beforeEach(() => {
  ...
  describe("create", () => {
    ...
    it('should return "createdParticipantes" if create was a success', async () => {
      const participantesEmGrupoData = [
        {
          participanteID: "1",
          torneioID: "1",
          grupoID: "1"
