...
// src/controllers/Participantes/ParticipantesController.spec.ts
describe("Testes unit\xE1rios para Controle de Dados na Tabela Participantes", () => {
  let participantesController;
  let req;
  let res;
  beforeEach(() => {
  ...
  describe("create", () => {
    it('should return null if "data" is invalid', async () => {
      const createdparticipantesData = [];
